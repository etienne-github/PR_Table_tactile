...
;
	...
	public CircularShellScene(MTApplication mtApplication, String name) {
		...
		BrowserButton button = new BrowserButton(mtApplication, 600, 400, 0, 85, 85, 20, 20);
...
//		getCanvas().addChild(rect);
	...
	private class BrowserButton extends MTRoundRectangle{
		...
		public BrowserButton(PApplet pApplet, float x, float y, float z,
				float width, float height, float arcWidth, float arcHeight) {
			super(x, y, z, width, height, arcWidth, arcHeight, pApplet);
