 ...
 *
 ***********************************************************************/
package org.mt4j.components.visibleComponents.widgets.pdf;
...
import org.mt4j.components.visibleComponents.widgets.ThreadAndPreDrawAction;
...
public class MTPDF extends MTRectangle {
	...
	private static CachedPDFPageLoader previewLoader = new CachedPDFPageLoader(1.5, 20);
	/**
