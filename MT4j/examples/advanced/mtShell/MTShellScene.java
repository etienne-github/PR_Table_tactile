...
//		listHeight = app.width - 50;
		...
		font = FontManager.getInstance().createFont(app, "SansSerif", 11, MTColor.WHITE, MTColor.WHITE, true);
...
//		System.out.println("Width: " + width + " Height:" + height);
		...
		float realListCellWidth = listHeight - bothBorders;
...
//		p.setStrokeColor(new MTColor(150,150,150, 255));
		...
		Vertex[] verticesRef = new Vertex[]{
				new Vertex(realListCellWidth - preferredIconHeight - reflectionDistanceFromImage, 				 					border,	0, 	0,0),
				new Vertex(realListCellWidth - preferredIconHeight - reflectionDistanceFromImage,						listCellHeight -border,	0, 	1,0),
				new Vertex(realListCellWidth - preferredIconHeight - reflection.height - reflectionDistanceFromImage, 	listCellHeight -border,	0, 	1,1),
				new Vertex(realListCellWidth - preferredIconHeight - reflection.height - reflectionDistanceFromImage,				border,	0, 	0,1),
				new Vertex(realListCellWidth - preferredIconHeight - reflectionDistanceFromImage, 									border,	0, 	0,0),
		};
