...
import org.mt4j.input.gestureAction.InertialCenteredDragAction;
				...
				if (instance.getCurrentScene() != null){
					...
					instance.invokeLater(new Runnable() {
						public void run() {
							...
							r.addGestureListener(DragProcessor.class, new InertialCenteredDragAction(instance));
				...
				if (instance.getCurrentScene() != null){
					...
					instance.invokeLater(new Runnable() {
						public void run() {
							...
							e.addGestureListener(DragProcessor.class, new InertialCenteredDragAction(instance));
